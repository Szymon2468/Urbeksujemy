export const cities = [
  { name: 'Aleksandrów Kujawski', N: 52.88, E: 18.7, active: false },
  { name: 'Aleksandrów Łódzki', N: 51.82, E: 19.29, active: false },
  { name: 'Andrychów', N: 49.86, E: 19.33, active: false },
  { name: 'Augustów', N: 53.83, E: 23.0, active: false },
  { name: 'Barlinek', N: 52.99, E: 15.19, active: false },
  { name: 'Bartoszyce', N: 54.24, E: 20.8, active: false },
  ...
  { name: 'Białogard', N: 54.0, E: 15.97, active: false },
  ...
  { name: 'Bieruń', N: 50.1, E: 19.1, active: false },
  ...
  { name: 'Brzesko', N: 49.96, E: 20.6, active: false },
  { name: 'Brzeszcze', N: 49.99, E: 19.14, active: false },
  { name: 'Brzeziny', N: 51.8, E: 19.74, active: false },
  ...
  { name: 'Bytom', N: 50.34, E: 18.9, active: false },
  ...
  { name: 'Czersk', N: 53.8, E: 17.97, active: false },
  ...
  { name: 'Dąbrowa Tarnowska', N: 50.17, E: 21.0, active: false },
  ...
  { name: 'Drawsko Pomorskie', N: 53.52, E: 15.8, active: false },
  ...
  { name: 'Garwolin', N: 51.9, E: 21.62, active: false },
  ...
  { name: 'Głowno', N: 51.97, E: 19.7, active: false },
  ...
  { name: 'Gołdap', N: 54.31, E: 22.3, active: false },
  ...
  { name: 'Góra Kalwaria', N: 51.99, E: 21.2, active: false },
  { name: 'Gorlice', N: 49.67, E: 21.15, active: false },
  { name: 'Gorzów Wielkopolski', N: 52.74, E: 15.23, active: false },
  { name: 'Gostyń', N: 51.87, E: 17.0, active: false },
  { name: 'Gostynin', N: 53.43, E: 19.43, active: false },
  { name: 'Grajewo', N: 53.65, E: 22.44, active: false },
  { name: 'Grodków', N: 50.7, E: 17.37, active: false },
  { name: 'Grodzisk Mazowiecki', N: 52.1, E: 20.62, active: false },
  ...
  { name: 'Kartuzy', N: 54.32, E: 18.2, active: false },
  { name: 'Katowice', N: 50.25, E: 19.02, active: false },
  { name: 'Kędzierzyn-Koźle', N: 50.34, E: 18.2, active: false },
  { name: 'Kępno', N: 51.28, E: 18.0, active: false },
  { name: 'Kętrzyn', N: 54.07, E: 21.37, active: false },
  { name: 'Kęty', N: 49.87, E: 19.21, active: false },
  { name: 'Kielce', N: 50.88, E: 20.64, active: false },
  { name: 'Kłobuck', N: 50.9, E: 18.94, active: false },
  { name: 'Kłodzko', N: 50.43, E: 16.65, active: false },
  { name: 'Kluczbork', N: 50.98, E: 18.2, active: false },
  { name: 'Knurów', N: 50.22, E: 18.66, active: false },
  { name: 'Kobyłka', N: 52.33, E: 21.2, active: false },
  ...
  { name: 'Konin', N: 52.2, E: 18.24, active: false },
  { name: 'Końskie', N: 51.2, E: 20.39, active: false },
  ...
  { name: 'Kożuchów', N: 51.75, E: 15.6, active: false },
  ...
  { name: 'Krosno', N: 49.7, E: 21.75, active: false },
  { name: 'Krosno Odrzańskie', N: 52.06, E: 15.1, active: false },
  { name: 'Krotoszyn', N: 51.7, E: 17.43, active: false },
  ...
  { name: 'Legionowo', N: 52.4, E: 20.92, active: false },
  { name: 'Legnica', N: 51.2, E: 16.15, active: false },
  { name: 'Leszno', N: 51.84, E: 16.57, active: false },
  { name: 'Leżajsk', N: 50.25, E: 22.42, active: false },
  { name: 'Libiąż', N: 50.1, E: 19.29, active: false },
  { name: 'Lidzbark Warmiński', N: 54.13, E: 20.59, active: false },
  { name: 'Limanowa', N: 49.7, E: 20.41, active: false },
  ...
  { name: 'Lubawa', N: 53.5, E: 19.74, active: false },
  { name: 'Lubin', N: 51.39, E: 16.2, active: false },
  ...
  { name: 'Lwowek Slaski', N: 51.11, E: 15.6, active: false },
  { name: 'Łańcut', N: 50.06, E: 22.22, active: false },
  { name: 'Łapy', N: 52.98, E: 22.89, active: false },
  { name: 'Łask', N: 51.6, E: 19.14, active: false },
  ...
  { name: 'Maków Mazowiecki', N: 52.86, E: 21.1, active: false },
  { name: 'Malbork', N: 54.04, E: 19.04, active: false },
  { name: 'Marki', N: 52.32, E: 21.11, active: false },
  { name: 'Miastko', N: 54.0, E: 16.96, active: false },
  ...
  { name: 'Nowa Ruda', N: 50.59, E: 16.5, active: false },
  { name: 'Nowa Sól', N: 51.8, E: 15.7, active: false },
  { name: 'Nowe Miasto Lubawskie', N: 53.43, E: 19.59, active: false },
  { name: 'Nowogard', N: 53.66, E: 15.1, active: false },
  { name: 'Nowy Dwór Gdański', N: 54.22, E: 19.12, active: false },
  { name: 'Nowy Dwór Mazowiecki', N: 52.42, E: 20.7, active: false },
  ...
  { name: 'Oborniki', N: 52.65, E: 16.8, active: false },
  { name: 'Oława', N: 50.94, E: 17.29, active: false },
  { name: 'Olecko', N: 54.04, E: 22.5, active: false },
  { name: 'Oleśnica', N: 51.2, E: 17.37, active: false },
  { name: 'Olesno', N: 50.88, E: 18.4, active: false },
  ...
  { name: 'Ostrów Mazowiecki', N: 52.79, E: 21.9, active: false },
  ...
  { name: 'Otwock', N: 52.1, E: 21.28, active: false },
  ...
  { name: 'Parczew', N: 51.63, E: 22.9, active: false },
  { name: 'Pasłęk', N: 54.06, E: 19.65, active: false },
  { name: 'Piaseczno', N: 52.06, E: 21.02, active: false },
  { name: 'Piastów', N: 52.2, E: 20.92, active: false },
  { name: 'Piekary Śląskie', N: 50.4, E: 18.95, active: false },
  ...
  { name: 'Piotrków Trybunalski', N: 51.4, E: 19.7, active: false },
  { name: 'Pisz', N: 53.63, E: 21.79, active: false },
  { name: 'Pleszew', N: 51.9, E: 17.77, active: false },
  { name: 'Płock', N: 52.55, E: 19.7, active: false },
  { name: 'Płonsk', N: 52.62, E: 20.37, active: false },
  { name: 'Polaniec', N: 50.42, E: 21.28, active: false },
  { name: 'Polczyn-Zdrój', N: 53.77, E: 16.1, active: false },
  { name: 'Police', N: 53.54, E: 14.55, active: false },
  { name: 'Polkowice', N: 51.5, E: 16.04, active: false },
  { name: 'Poniatowa', N: 51.18, E: 22.12, active: false },
  { name: 'Poręba', N: 50.48, E: 19.33, active: false },
  { name: 'Poznań', N: 52.39, E: 16.9, active: false },
  ...
  { name: 'Przeworsk', N: 50.06, E: 22.5, active: false },
  { name: 'Pszczyna', N: 49.97, E: 18.95, active: false },
  { name: 'Pszów', N: 50.03, E: 18.4, active: false },
  { name: 'Puck', N: 54.7, E: 18.4, active: false },
  ...
  { name: 'Rawicz', N: 51.6, E: 16.86, active: false },
  ...
  { name: 'Rybnik', N: 50.1, E: 18.54, active: false },
  ...
  { name: 'Sanok', N: 49.57, E: 22.2, active: false },
  ...
  { name: 'Sieradz', N: 51.6, E: 18.74, active: false },
  ...
  { name: 'Skoczów', N: 49.8, E: 18.79, active: false },
  ...
  { name: 'Sokółka', N: 53.4, E: 23.5, active: false },
  { name: 'Sokołow Podlaski', N: 52.4, E: 22.23, active: false },
  ...
  { name: 'Sulecin', N: 52.45, E: 15.1, active: false },
  { name: 'Sulejówek', N: 52.25, E: 21.27, active: false },
  { name: 'Suwałki', N: 54.1, E: 22.94, active: false },
  { name: 'Swarzędz', N: 52.4, E: 17.06, active: false },
  { name: 'Syców', N: 51.3, E: 17.7, active: false },
  ...
  { name: 'Świecie', N: 53.4, E: 18.44, active: false },
  { name: 'Świętochłowice', N: 50.29, E: 18.94, active: false },
  { name: 'Świnoujście', N: 53.9, E: 14.24, active: false },
  { name: 'Tarnobrzeg', N: 50.59, E: 21.68, active: false },
  { name: 'Tarnów', N: 50.0, E: 20.99, active: false },
  ...
  { name: 'Toruń', N: 53.02, E: 18.6, active: false },
  ...
  { name: 'Tychy', N: 50.16, E: 19.0, active: false },
  ...
  { name: 'Wągrowiec', N: 52.81, E: 17.2, active: false },
  ...
  { name: 'Wesoła', N: 52.25, E: 21.2, active: false },
  ...
  { name: 'Władysławowo', N: 54.78, E: 18.4, active: false },
  ...
  { name: 'Wodzisław Śląski', N: 50.03, E: 18.4, active: false },
  ...
  { name: 'Wolsztyn', N: 52.1, E: 16.1, active: false },
  { name: 'Wrocław', N: 51.11, E: 17.03, active: false },
  { name: 'Wronki', N: 52.7, E: 16.36, active: false },
  { name: 'Września', N: 52.32, E: 17.57, active: false },
  { name: 'Wschowa', N: 51.79, E: 16.31, active: false },
  { name: 'Wysokie Mazowieckie', N: 52.91, E: 22.5, active: false },
  ...
  { name: 'Zduńska Wola', N: 51.6, E: 18.94, active: false },
  { name: 'Zdzieszowice', N: 50.41, E: 18.12, active: false },
  { name: 'Zgierz', N: 51.86, E: 19.41, active: false },
  { name: 'Zgorzelec', N: 51.14, E: 15.0, active: false },
  ...
  { name: 'Złocieniec', N: 53.52, E: 16.0, active: false },
  { name: 'Złotoryja', N: 51.11, E: 15.9, active: false },
  ...
  { name: 'Żnin', N: 52.85, E: 17.7, active: false },
